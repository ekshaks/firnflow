...
async fn run_gates(
    ...
    let cold = manager
        .query(ns, q.clone(), None, 10, None, None, None, false, false)
        .await
    ...
    let after = manager
        .query(ns, mvec, None, 1, None, None, None, false, false)
        .await
    ...
    manager2
        .query(ns, vec_for(7), None, 1, None, None, None, false, false)
        .await
