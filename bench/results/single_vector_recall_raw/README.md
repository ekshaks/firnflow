...
| `nprobes_exhaustive_100k_build3.json` | The full `nprobes` curve, 1 to 1000, for the third of those builds. Recall climbs from 0.4625 to 0.587 between 1 and 10 partitions, then neither it nor latency moves across the remaining hundred-fold increase. |
